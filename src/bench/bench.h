...
#elif OS_MAC
#  include "bench.mac.h"
global B32 (*bench_init__platform)(void) = bench_init__mac;
global B32 (*bench_use_counters__platform)(void) = bench_use_counters__mac;
global Bench_Result (*bench_run_proc__platform)(Bench_Proc *p, void *args) = bench_run_proc__mac;
#elif OS_WINDOWS
