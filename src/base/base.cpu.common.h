...
#else
#  error ERROR: atomic operations not implemented for this compiler
#endif
...
static inline U32
msb_helper(U64 num)
{ U32 index = 0; _BitScanReverse64(&index, num | 1); return(index); }
static inline U32
lsb_helper(U64 num)
{ U32 index = 0; _BitScanForward64(&index, num | 1); return(index); }
#  define MSB(n) msb_helper(n)
#  define LSB(n) lsb_helper(n)

#else
#  error ERROR: MSB/LSB operations not implemented for this compiler
#endif
